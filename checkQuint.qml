...
MuseScore {
      menuPath: "Plugins.Proof Reading.Check for consecutive 5ths"
      description: "Check for parallel fifths also ascending hidden parallels."
      version: "0.2"
      requiresScore: true
      ...
      Component.onCompleted : {
            if (mscoreMajorVersion >= 4) {
                  checkParallels.title = "Check for Parallel 5ths";
