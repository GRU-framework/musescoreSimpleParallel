...
MuseScore {
      menuPath: "Plugins.Proof Reading.Check for parallel 8ves"
      description: "Check for parallel octaves.\nMarks consecutive  octaves and also ascending hidden parallels."
      version: "0.2"
      requiresScore: true
      ...
      Component.onCompleted : {
            if (mscoreMajorVersion >= 4) {
                  checkParallels.title = "Check for Parallel 8ves";
